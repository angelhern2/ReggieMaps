    ...
    func loadBuildings() {
            buildings = [
             ...
             //   CampusBuilding(buildingCode: [" lsit attrbutes"],name: "name of building", coordinate: CLLocationCoordinate2D(latitude: 40.54497, longitude: -88.98852)),    // to add new buildings 
                ...
                //b
                CampusBuilding(buildingCode: ["Bowling & Billiards Center","BBC (000-499)"], name: "Bowling & Billiards Center",            coordinate: CLLocationCoordinate2D(latitude: 40.512045, longitude: -88.990856)),
                ...
                CampusBuilding(buildingCode: ["Bone Student Center","BON (000-499)" ,"Starbucks", "Brown Ball Room", "Redbird Spirit Shop", "Welcome Desk","ISU Credit Union"], name: "Bone Student Center", coordinate: CLLocationCoordinate2D(latitude: 40.51183, longitude: -88.99224)),
                //c
                ...
                CampusBuilding(buildingCode: ["Centennial East","CE (000-499)","Westhoff Theatre","Illinois State University Bands","Dance Studio","School of Music" ,"Kemp Recital Hall"],name: "Centennial East", coordinate: CLLocationCoordinate2D(latitude: 40.506907, longitude: -88.989938)),
                ...
                CampusBuilding(buildingCode: ["Cook Hall","CH (000-499)"],name: "Cook Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50936,  longitude: -88.99218)),
                //d
                ...
                CampusBuilding(buildingCode: ["DeGarmo Hall","DEG (000-499)","Cecilia J. Lauby Teacher Education Center","Center for the Study of Educational Policy","College of Education","Department of Psychology","Grapevine Publication","School of Teaching and Learning","Special Education","Studio TEaCH"], name: "DeGarmo Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50894, longitude: -88.99265)),
                //e
                CampusBuilding(buildingCode: ["Eyestone School Museum","ES (000-499)"],name: "Eyestone School Museum", coordinate: CLLocationCoordinate2D(latitude: 40.51061, longitude: -89.0012)),
                CampusBuilding(buildingCode: ["Edwards Hall","EWD (000-499)","Capen Auditorium","School of Nursing","Mennonite College of Nursing"], name: "Edwards Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50987, longitude: -88.99217)),
                ...
                //f
                CampusBuilding(buildingCode: ["Fairchild Hall","FH (000-499)", "Department of Communication Sciences and Disorders"],name: "Fairchild Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50892, longitude: -88.99393)),
                CampusBuilding(buildingCode: ["Fell Hall","FEL (000-499)","Office of International Studies and Programs","School of Communication","School of Communication Advisement Center","Student Access and Accommodation Services","Study Abroad","TRiO/Student Support Services","TV-10 News","University College","University College Academic Advisement","WZND Radio","Women's Mentoring Network"],name: "Fell Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50841, longitude: -88.99213)),
                CampusBuilding(buildingCode: ["Felmley Hall of Science","FHS (000-499)","FSA","Department of Geography, Geology, and the Environment","Department of Health Sciences","The Institute for Geospatial Analysis & Mapping (GEOMAP)","Felmley Hall of Science Annex"],name: "Felmley Hall of Science", coordinate: CLLocationCoordinate2D(latitude: 40.51035, longitude: -88.99092)),
                ...
                CampusBuilding(buildingCode: [" Haynie Hall","HAY (000-499)"],name: " Haynie Hall", coordinate: CLLocationCoordinate2D(latitude: 40.51237, longitude: -88.99989)),
                CampusBuilding(buildingCode: ["Hovey Hall","HOV (000-499)","Academic Senate","Budget Office","Division of Student Affairs","Financial Aid Office","Graduate School","Media Relations","Office of Admissions","Office of Enrollment Management and Academic Services","Office of Equal Opportunity and Access","Office of General Counsel","Office of Internal Auditing","Office of the Comptroller","Office of the President","Office of the Provost","Planning, Research, & Policy Analysis","Title IX","Vice President of Finance and Planning"],name: "Hovey Hall", coordinate: CLLocationCoordinate2D(latitude: 40.5094, longitude: -88.98997)),
                ...
                //j
                CampusBuilding(buildingCode: ["Julian Hall","JH (000-499)","Department of Chemistry","Digital Innovation, Graphics, and Gaming Studio","School of Biological Sciences","Technology Solutions","Technology Support Center"],name: "Julian Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50994,    longitude: -88.98909)),
                ...
                CampusBuilding(buildingCode: ["Multicultural Center","MCC (000-499)"],name: "Multicultural Center", coordinate: CLLocationCoordinate2D(latitude: 40.50833, longitude: -88.99518)),
                CampusBuilding(buildingCode: ["Moulton Hall","MLT (000-499)","Department of Physics","Office of the University Registrar","Testing Services","Veterans and Military Services" ],name: "Moulton Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50989, longitude: -88.99036)),
                CampusBuilding(buildingCode: ["Mennonite College of Nursing Simulation Center","MNSC (000-499)","Nursing Simulation Laboratory"],name: "Mennonite College of Nursing Simulation Center", coordinate: CLLocationCoordinate2D(latitude: 40.51329 ,   longitude: -88.99174)),
                CampusBuilding(buildingCode: ["Metcalf School","MLS (000-499)"],name: "Metcalf School", coordinate: CLLocationCoordinate2D(latitude: 40.50959,  longitude: -88.99382)),
                //n
                CampusBuilding(buildingCode: ["Nelson Smith Building","NSB (000-499)","Human Resources","Learning Spaces & Audio/Visual Technologies","Mail Service Center","Printing Services","University Police"],name: "Nelson Smith Building", coordinate: CLLocationCoordinate2D(latitude: 40.51031,    longitude: -89.0001)),
                ...
                CampusBuilding(buildingCode: ["Old Union","OU (000-499)","School of Information Technology","Web & Interactive Communications","Web and Interactive Communications"],name: "Old Union", coordinate: CLLocationCoordinate2D(latitude: 40.50876, longitude: -88.98997)),
                ...
                //r
                CampusBuilding(buildingCode: ["Rachel Cooper","RC (000-499)","Center for Adoption Studies","Eckelmann-Taylor Speech and Hearing Clinic","School of Social Work","Women's, Gender, and Sexuality Studies Program"],name: "Rachel Cooper", coordinate: CLLocationCoordinate2D(latitude: 40.50873 ,   longitude: -88.99346)),
                ...
                CampusBuilding(buildingCode: ["Ropp Agriculture CampusBuilding","RAB (000-499)","Department of Agriculture"], name: "Ropp Agriculture CampusBuilding", coordinate: CLLocationCoordinate2D(latitude: 40.51336, longitude: -88.99554)),
                ...
                //s
                CampusBuilding(buildingCode: ["Schroeder Hall","SCH (000-499)","Department of Criminal Justice Sciences","Department of History","Department of Politics and Government","Department of Sociology and Anthropology","Developmental Math Lab","Thomas Eimermann Pre-Law Advisement Center"],name: "Schroeder Hall", coordinate: CLLocationCoordinate2D(latitude: 40.51031, longitude: -88.99183)),
                ...
                CampusBuilding(buildingCode: ["State Farm Hall of Business","SFHB (000-499)","College of Business","College of Business Academic Advisement","Department of Accounting","Department of Finance, Insurance, and Law","Department of Management","George R. and Martha Means Center for Entrepreneurial Studies","Katie School of Insurance and Financial Services" ,"Marketing" ,"Master of Business Administration Program" ,"Professional Sales Institute","The Business Bistro" ],name: "State Farm Hall of Business", coordinate: CLLocationCoordinate2D(latitude: 40.507008, longitude: -88.991784)),
                CampusBuilding(buildingCode: ["Student Accounts","SAB (000-499)","Cashier's Office","Student Accounts Office"],name: "Student Accounts Building", coordinate: CLLocationCoordinate2D(latitude: 40.508485, longitude: -88.996017)),
                ...
                CampusBuilding(buildingCode: ["Stevenson Hall","STV (000-499)","Actuarial Program - Department of Mathematics","Applied Social Research Unit","Center for Writing Research & Pedagogy","College of Arts and Sciences","Department of Economics","Department of English","Department of Languages, Literatures, and Cultures","Department of Mathematics" ,"Department of Philosophy" ,"Institute for Regulatory Policy Studies","Stevenson Center for Community and Economic Development"],name: "Stevenson Hall", coordinate: CLLocationCoordinate2D(latitude: 40.508085, longitude: -88.989038)),
                CampusBuilding(buildingCode: ["Science Laboratory Building","SLB (000-499)"],name: "Science Laboratory Building", coordinate: CLLocationCoordinate2D(latitude: 40.509688, longitude: -88.988196)),
                //t
                CampusBuilding(buildingCode: ["Turner Hall","TUR (000-499)","Child Care Center","College of Applied Science and Technology","Department of Family & Consumer Sciences","Department of Technology"],name: "Turner Hall", coordinate: CLLocationCoordinate2D(latitude: 40.51079, longitude: -88.99708)),
                //u
                CampusBuilding(buildingCode: ["University High School","UH (000-499)","Stroud Auditorium"],name: "University High School", coordinate: CLLocationCoordinate2D(latitude: 40.51556, longitude: -88.99609)),
                ...
                CampusBuilding(buildingCode: ["Williams Hall","WHA ","WIH (000-499)","Williams Hall Annex","Center for Integrated Professional Development","College of Engineering","Electrical Engineering","General Engineering","Interdisciplinary Programs","Mechanical Engineering","Opscan Evaluation"],name: "Williams Hall", coordinate: CLLocationCoordinate2D(latitude: 40.50822, longitude: -88.98988)),
                CampusBuilding(buildingCode: ["Warehouse Road Complex 1","WRC1 (000-499)"],name: "Warehouse Road Complex 1", coordinate: CLLocationCoordinate2D(latitude: 40.5439, longitude: -88.98809)),
                CampusBuilding(buildingCode: ["Warehouse Road Complex 2","WRC2 (000-499)"],name: "Warehouse Road Complex 2", coordinate: CLLocationCoordinate2D(latitude: 40.54497, longitude: -88.98852)),
                CampusBuilding(buildingCode: ["Wright Hall","WRT (000-499)"],name: "Wright Hall", coordinate: CLLocationCoordinate2D(latitude: 40.512652, longitude: -89.000828))
            ]
    }
